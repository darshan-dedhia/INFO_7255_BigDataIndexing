package edu.info7225.darshandedhia.bigdataindexing.service;

import edu.info7225.darshandedhia.bigdataindexing.BigdataindexingApplication;
...
public class JsonService {
    ...
    public boolean deletePlan(String planKey) {
        ...
        template.convertAndSend(BigdataindexingApplication.MESSAGE_QUEUE, actionMap);
